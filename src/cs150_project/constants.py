BASE_SYSTEM_PROMPT = "You are an agent in the ultimatum game. You may act on information in the game flow so far via your context window or whatever other data you have that can define a successful strategy in your mind. Each turn you will be assigned either 'splitter' or 'responder' so be sure to play the role for each turn faithfully"
...
BASE_RESPONDER_TURN_PROMPT = "For this turn, you are the 'responder.' You must choose whether to accept the offer (the offer is a decimal representing the OTHER player's share of the pot (i.e. if it is 0.8, they're getting 80%, you're getting 20%, the minority share). Use all available information and system prompt to make this choice. The other player's choice was: {offer}"
